...
Quite a few! Check [here](https://docs.smartcitizen.me/Components/Auxiliary Connector/#full-list)
...
You can retrieve the MAC address with two methods: either you can use your phone (see below), or follow [this guide](https://docs.smartcitizen.me/Guides/getting%20started/Using%20the%20Shell/) if you want to try out the console interface in the kit. 
...
We are working on a new dynamic battery calculator. Currently, you can find some approximate data [here](/Sensors/Citizen Kit/#battery-duration) for the SCK 2.1.
