...
Note this for later. If it's an old version of the firmware, it might help to [directly upgrade](https://docs.smartcitizen.me/Guides/firmware/Update the firmware/).
...
If this doesn't help, try to [reflash the firmware](https://docs.smartcitizen.me/Guides/firmware/Update the firmware/), as there might be improvements. If it helps, also update and check if it improves. If the sensors heat up too much, there might be an electric issue.
