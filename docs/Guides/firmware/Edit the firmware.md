...
!!! info "Bricked kit?"
    Check [this guide](https://docs.smartcitizen.me/guides/firmware/recovering-the-bootloader/) on how to identify and recover the bootloader.
